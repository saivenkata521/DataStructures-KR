...
void  max_odd_num_path( bstptr T , string s   ){
	...
	if( T -> lc )
		max_odd_num_path( T -> lc , s+to_string(T->lc->data) );
	
	if( T -> rc )
		max_odd_num_path( T -> rc , s+to_string(T->rc->data) );
...
*/
	...
	max_odd_num_path( T , ""+to_string(T->data) );
